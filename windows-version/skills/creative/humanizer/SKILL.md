...
## 中文 AI 文本特征（from natural-language-optimizer）

中文 AI 文本有额外的特征模式：

### 过度象征
```
❌ "这不仅仅是一个工具，它是一座桥梁，连接梦想与现实"
✅ "这个工具帮助实现目标"
```
...
### 中文填充短语
⚠️ 避免: "值得注意的是"、"重要的是要记住"、"总而言之"、"使用这个工具，可以帮助提高效率"

### 风格选项

| 风格 | 特点 | 适用场景 |
|------|------|---------|
| formal | 正式、专业 | 商务文档、报告 |
| academic | 学术、严谨 | 论文、研究 |
| casual | 随意、自然 | 社交媒体、博客 |
