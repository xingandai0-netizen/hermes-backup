...
All three feed files have `generatedAt: 2026-04-17` — that's **75 days old**, far exceeding the 72-hour freshness threshold. In cron mode with stale data, the documented behavior is to suppress delivery.
