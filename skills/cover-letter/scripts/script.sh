#!/usr/bin/env bash
# cover-letter - Multi-purpose utility tool
set -euo pipefail
VERSION="2.0.0"
DATA_DIR="${COVER_LETTER_DIR:-${XDG_DATA_HOME:-$HOME/.local/share}/cover-letter}"
...
Usage: cover-letter <command> [args]
...
case "${1:-help}" in
    ...
    info) shift; cmd_info "$@" ;;
    help|-h) show_help ;;
    version|-v) echo "cover-letter v$VERSION" ;;
